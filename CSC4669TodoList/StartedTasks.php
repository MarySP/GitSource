...
<html>
    ...
    <body>
        ...
        <div class="btn-group">
         ...
         <?php
        require 'config.php';
            $result = $conn->query("SELECT s.TaskID, Title, DueDate FROM  started s, Thelist l "
                    . "where l.TaskID = s.TaskID and l.theStatus = 'STARTED'");
            echo ("<br><br><br>");
            ...
            ?>
        <h2></h2>
          <input id = 'markComplete' type="submit" value="Mark as Complete" name = "markComplete" />
